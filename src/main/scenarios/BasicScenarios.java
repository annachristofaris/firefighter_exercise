...
public class BasicScenarios {
	@Test
	public void singleFire() throws FireproofBuildingException, NoFireFoundException, OutOfCityBoundsException,
	...
	public void singleFireDistanceTraveledDiagonal() throws FireproofBuildingException, NoFireFoundException,
			OutOfCityBoundsException, NoFirefightersAvailableException {
	...
	@Test
	public void simpleDoubleFire() throws FireproofBuildingException, NoFireFoundException, OutOfCityBoundsException,
			NoFirefightersAvailableException {
		City basicCity = new CityImpl(2, 2, new CityNode(0, 0));
		FireDispatch fireDispatch = basicCity.getFireDispatch();
